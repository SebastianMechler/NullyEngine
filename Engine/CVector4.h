...
inline Nully::CVector4 operator+(const Nully::CVector4& a_vector1, const Nully::CVector4& a_vector2)
{
  Nully::CVector4 tmp;
...
inline Nully::CVector4 operator*(const Nully::CVector4& a_vector1, const Nully::float_c a_scalar)
{
  Nully::CVector4 tmp;
...
/// @param a_vector1 A vector as reference.
/// @return Returns a new sized vector.
inline Nully::CVector4 operator*(const Nully::float_c a_scalar, const Nully::CVector4& a_vector1)
{
  Nully::CVector4 tmp;
  tmp.x = a_vector1.x * a_scalar;
  tmp.y = a_vector1.y * a_scalar;
...
inline Nully::bool_c operator==(const Nully::CVector4& a_vector1, const Nully::CVector4& a_vector2)
{
  return (a_vector1.x - a_vector2.x < Nully::CVector4::epsilon) &&
    (a_vector1.y - a_vector2.y < Nully::CVector4::epsilon) &&
    (a_vector1.z - a_vector2.z < Nully::CVector4::epsilon) &&
    (a_vector1.w - a_vector2.w < Nully::CVector4::epsilon);
}
