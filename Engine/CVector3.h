...
inline Nully::Math::CVector3 operator+(const Nully::Math::CVector3& a_vector1, const Nully::Math::CVector3& a_vector2)
{
  Nully::Math::CVector3 tmp;
...
inline Nully::Math::CVector3 operator*(const Nully::Math::CVector3& a_vector1, const Nully::float_c a_scalar)
{
  Nully::Math::CVector3 tmp;
...
/// @param a_vector1 A vector as reference.
/// @return Returns a new sized vector.
inline Nully::Math::CVector3 operator*(const Nully::float_c a_scalar, const Nully::Math::CVector3& a_vector1)
{
  Nully::Math::CVector3 tmp;
  tmp.x = a_vector1.x * a_scalar;
  tmp.y = a_vector1.y * a_scalar;
...
inline Nully::bool_c operator==(const Nully::Math::CVector3& a_vector1, const Nully::Math::CVector3& a_vector2)
{
  return (a_vector1.x - a_vector2.x < Nully::Math::CVector3::epsilon) &&
    (a_vector1.y - a_vector2.y < Nully::Math::CVector3::epsilon) &&
    (a_vector1.z - a_vector2.z < Nully::Math::CVector3::epsilon);
}
